...
def get_all_city_names_and_hour_values
  begin
    ...
    page = HTTParty.get("http://www.lavinia.fr/fr/domaines")
    parse_page = Nokogiri::HTML(page)

    #Get weather data names and put it in an array of hashes called weather_data
    xpath_name = '//*[@id="footer_index_resources"]/div/article/ul/li/a'
...
get_array_of_hashes_to_csv(clock_data,"all_lavinia.csv")
puts_object_in_json_file(clock_data,"all_lavinia.json")
